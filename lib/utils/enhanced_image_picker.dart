      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
            ...
            style: AppStyles.custom(color: AppTheme.textSecondaryLight),
          ),
      ...
      CroppedFile? croppedFile = await ImageCropper().cropImage(
        ...
        uiSettings: [
          AndroidUiSettings(
            ...
            toolbarWidgetColor: AppTheme.backgroundLight,
    ...
    return GestureDetector(
      ...
      child: Column(
        children: [
          ...
          Text(
            label,
            style: AppStyles.custom(color: AppTheme.textSecondaryDark),
          ),
        ],
      ),
    );
  ...
  void _showErrorSnackBar(String message) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Row(
          children: [
            Icon(Icons.error_outline, color: AppTheme.backgroundLight),
    ...
    return Column(
      ...
      children: [
        ...
        if (_errorMessage.isNotEmpty && !_hasPermissionError) ...[
          ...
          Text(
            _errorMessage,
            style: AppStyles.custom(color: AppTheme.primaryRed, size: 12),
          ),
        ],
      ],
    );
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              _errorMessage,
              style: AppStyles.custom(color: AppTheme.errorLight, size: 12),
