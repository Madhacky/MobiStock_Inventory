...
class GstLedgerEntry {
  ...
  String get formattedTotalGst => '₹${(cgstAmount + sgstAmount + igstAmount).toStringAsFixed(2)}';
  String get formattedTotalAmount => '₹${(taxableAmount + cgstAmount + sgstAmount + igstAmount).toStringAsFixed(2)}';
