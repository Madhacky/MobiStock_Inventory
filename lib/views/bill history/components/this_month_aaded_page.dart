            ...
            Row(
              children: [
                Expanded(
                  child: _buildStatCard(
                    'Unique Models',
                    controller.uniqueModels.value.toString(),
                    Icons.devices,
                    Color(0xFF8B5CF6),
                  ),
                ),
                ...
                Expanded(
                  child: _buildStatCard(
                    'Companies',
                    controller.uniqueCompanies.value.toString(),
                    Icons.business,
                    Color(0xFFEF4444),
                  ),
                ),
                SizedBox(width: 8),
                Expanded(child: SizedBox()), // Empty space to balance
              ],
            ),
          ],
        );
  ...
  Widget _buildStockItemCard(ThisMonthStockItem item) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: controller.getCategoryColor(item.itemCategory).withValues(alpha: 0.15),
          width: 1,
        ),
      ),
      child: Column(
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  controller.getCompanyColor(item.company).withValues(alpha: 0.1),
                  controller.getCompanyColor(item.company).withValues(alpha: 0.05),
                ],
          ...
          children: [
                ...
                Expanded(
                  child: Obx(
                    () => buildStyledDropdown(
                      ...
                      value: controller.selectedCompany.value == 'All'
                          ? null
            ...
            Obx(
              () => buildStyledDropdown(
                ...
                items: controller.sortOptions.map((e) => controller.getSortDisplayName(e)).toList(),
                onChanged: (value) {
                  if (value != null) {
                    final sortField = controller.sortOptions.firstWhere(
                      (field) => controller.getSortDisplayName(field) == value,
                    );
