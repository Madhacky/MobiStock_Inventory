                        ...
                        child: DropdownButtonHideUnderline(
                          child: Obx(() => DropdownButton<String>(
                            ...
                            items: [
                              DropdownMenuItem(
                                value: 'date_desc',
                                child: Text('Latest First', style: TextStyle(fontSize: 14)),
                              ),
                              DropdownMenuItem(
                                value: 'date_asc',
                                child: Text('Oldest First', style: TextStyle(fontSize: 14)),
                              ),
                              DropdownMenuItem(
                                value: 'amount_desc',
                                child: Text('Highest Amount', style: TextStyle(fontSize: 14)),
                              ),
                              DropdownMenuItem(
                                value: 'amount_asc',
                                child: Text('Lowest Amount', style: TextStyle(fontSize: 14)),
                              ),
                            ],
                            onChanged: (value) {
                              if (value != null) {
                            ...
                            isExpanded: true,
                            hint: Text('Sort by', style: TextStyle(fontSize: 14)),
                          )),
                        ),
                      ),
