  ...
  Widget _buildErrorWidget() {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(Icons.error_outline, size: 64, color: const Color(0xFFE57373)),
          SizedBox(height: 16),
          Text(
          ...
          Padding(
            ...
            child: Text(
              ...
              style: AppStyles.custom(size: 14, color: const Color(0xFF757575)),
            ),
          ),
          SizedBox(height: 24),
          ElevatedButton.icon(
                  ...
                  if (index == controller.galleryImages.length) {
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Icon(Icons.add, color: AppTheme.grey600),
                      ),
                    );
                  }
      ...
      children: [
                ...
                controller.isEditing.value
                    ...
                    : Text(
                      ...
                      style: AppStyles.custom(
                        size: 14,
                        color:
                            url.isEmpty ? AppTheme.grey500 : AppTheme.black87,
                        weight: FontWeight.w500,
                      ),
                    ),
          ),
        ...
        if (!controller.isEditing.value && url.isNotEmpty)
          IconButton(
            ...
            icon: Icon(Icons.open_in_new, size: 16, color: AppTheme.grey600),
        ...
        children: [
          Container(
            ...
            child: TextButton.icon(
              ...
              label: Text(
                'Delete Account',
                style: AppStyles.custom(color: AppTheme.red600),
              ),
