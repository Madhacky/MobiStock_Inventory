  ...
  Widget _buildCustomAppBar() {
    return buildCustomAppBar(
      ...
      actionItem: IconButton(
        ...
        icon: Icon(Icons.refresh, color: AppTheme.black87),
      ),
    );
  }
        ...
        child: GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: isActive ? item.color : AppTheme.backgroundLight,
              borderRadius: BorderRadius.circular(25),
              border: Border.all(
                color: isActive ? item.color : AppTheme.greyOpacity03,
                width: 1.5,
              ),
              boxShadow:
                  isActive
              ...
              children: [
                AnimatedContainer(
                  ...
                  child: Icon(
                    ...
                    color:
                        isActive ? AppTheme.backgroundLight : AppTheme.grey700,
                    size: 18,
                  ),
                ),
                AnimatedContainer(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            title,
            style: AppStyles.custom(size: 11, color: AppTheme.grey600),
          ),
        ],
      ),
    );
