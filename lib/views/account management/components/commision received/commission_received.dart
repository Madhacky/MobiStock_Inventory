          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(
                  'Confirmed by:',
                  style: AppStyles.custom(size: 10, color: Color(0xFF9CA3AF)),
                ),
                const SizedBox(width: 4),
                Expanded(
                  child: Text(
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.money_off, size: 64, color: AppTheme.grey400),
          const SizedBox(height: 16),
          Text(
                  ...
                  children: [
                    Expanded(
                      child: ElevatedButton.icon(
                        ...
                        label: Text('Share', style: AppStyles.custom(size: 13)),
                        style: ElevatedButton.styleFrom(
                          backgroundColor: const Color(0xFF3B82F6),
                          foregroundColor: AppTheme.backgroundLight,
                    ...
                    Expanded(
                      child: ElevatedButton.icon(
                        ...
                        label: Text('Edit', style: AppStyles.custom(size: 13)),
                        style: ElevatedButton.styleFrom(
