...
class AccountManagementBinding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.put<CommissionReceivedController>(CommissionReceivedController(), permanent: false);
    Get.put<EmiSettlementController>(EmiSettlementController(), permanent: false);
